...
uint256 hashGenesisBlock("0xd9bd9fe9c784b9afa876afaa8c6d87f5335770d3ae8121ee7268a33aa5508e19");
static CBigNum bnProofOfWorkLimit = CBigNum().SetCompact(537261531); // GraySkullCoin: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "GraySkullCoin Signed Message:\n";
...
{
    // GraySkullCoin: IsDust() detection disabled, allows any valid dust to be relayed.
...
{
    int64 nSubsidy = 13000000000;

    // Subsidy is cut in half every 201,983 blocks, which will occur approximately every 140 days
    nSubsidy >>= (nHeight / 201983); // GraySkullCoin: 201,983 blocks in ~140 days

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 360; // GraySkullCoin: 6 minutes
static const int64 nTargetSpacing = 60; // GraySkullCoin: 1 minute
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // GraySkullCoin: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // GraySkullCoin: Special short-term limits to avoid 10,000 BDB lock limit:
...
{
    // GraySkullCoin: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x9ea2a514c759d56ffc7da885da10c9d89dd1bd51663df0ec40b1e3f1880da64c");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "I am Adam Prince of Eternia and defender of the secrets of Castle Grayskull";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 13000000000;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("8e34a8272a958c8a7609243264d80385b00f1af3601333f96067600b8c501e3e476899804155c19e435cb7458a483f09d534c26e67812b31c3239ed2cec356e72d") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1471157432;
        block.nBits    = 537261531;
        block.nNonce   = 1215622422;

        if (fTestNet)
        {
            block.nTime    = 1471157432;
            block.nNonce   = 1258862891;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0xe489efa5aa5b318f6fd2287f84fc1ce1a8cd794f9d922507ee0958abb64cf27e"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xfb, 0xc0, 0xb6, 0xdb }; // GraySkullCoin: increase each by adding 2 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("GraySkullCoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("GraySkullCoinMiner : ProcessBlock, block not accepted");
    }
